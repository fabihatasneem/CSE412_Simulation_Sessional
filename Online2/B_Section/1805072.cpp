...
bool without_lag = false;
int trials, amount, bigs, initial_inv_level, inv_level, next_event_type, num_events,
...
float area_holding, area_shortage, holding_cost, incremental_cost, maxlag,
    ...
    total_ordering_cost, cost_without_lag;
FILE *infile, *outfile;
...
int main() /* Main function. */
{
    ...
    fscanf(infile, "%d %d %d %d %d %f %f %f %f %f %f %f", &trials, &initial_inv_level,
    ...
    fprintf(outfile, " %-13s  %-18s  %-18s  %-18s \n", "Policy",
            "Avg_TC_With_Lag", "Avg_TC_Without_Lag", "Better?");
    fprintf(outfile, "--------------------------------------------------------------------------------------------------\n");
...
void evaluate(void) /* Inventory-evaluation event function. */
{
    ...
    if (inv_level < smalls)
    {
        ...
        cost_without_lag += setup_cost + incremental_cost * amount;
...
void report(void) /* Report generator function. */
{
    ...
    float avg_total_cost, avg_holding_cost, avg_ordering_cost, avg_shortage_cost, avg_cost_without_lag;
    avg_ordering_cost = total_ordering_cost / num_months;
    avg_holding_cost = holding_cost * area_holding / num_months;
    avg_shortage_cost = shortage_cost * area_shortage / num_months;
    avg_total_cost = avg_ordering_cost + avg_holding_cost + avg_shortage_cost;
    avg_cost_without_lag = cost_without_lag / num_months;
    if (avg_total_cost < avg_cost_without_lag)
        fprintf(outfile, "\n(%2d,%3d)%20.2f%20.2f%20s\n", smalls, bigs,
                avg_total_cost, avg_cost_without_lag, "With_Lag");
    else
        fprintf(outfile, "\n(%2d,%3d)%20.2f%20.2f%20s\n", smalls, bigs,
                avg_total_cost, avg_cost_without_lag, "Without_Lag");
}
